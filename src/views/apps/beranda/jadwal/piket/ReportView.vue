...
export default {
    ...
    methods: {
        ...mapActions('jadwal_piket', ['reportExport', 'report', 'attr']),
        getDataFromApi() {
            this.loading = true
                    ...
                    this.reportExport(this.tanggal).then((res) => {
                        ...
                        res.data.forEach(el => {
                            arr.push({
                                ...
                                "Tugas Piket": el.masterPiket.tugas,
                                "Jam": el.time,
                                "Tanggal": this.parseDate(el.date),
                                "Status Pelaksanaan": el.status === 'y' ? 'Sudah dilaksanakan': 'Belum dilaksanakan',
                            })
                        });
                        console.log(arr);
